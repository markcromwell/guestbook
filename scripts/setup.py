'''
setup.py — Install GUESTBOOK on a new machine.
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="GUESTBOOK installer")
